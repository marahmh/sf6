...
class TypeEvenementController extends AbstractController
{
    ...
    /**
     * @Route("/{idTypeEvenement}", name="app_type_evenement_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{idTypeEvenement}/edit", name="app_type_evenement_edit", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{idTypeEvenement}", name="app_type_evenement_delete", methods={"POST"})
     */
    public function delete(Request $request, TypeEvenement $typeEvenement, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$typeEvenement->getIdTypeEvenement(), $request->request->get('_token'))) {
